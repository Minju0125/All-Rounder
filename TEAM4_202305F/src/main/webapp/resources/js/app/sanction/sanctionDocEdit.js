...
$(function(){
	...
	let makeRecpList = function (resp) {
	   ...
	   tags += `<option value="${firstCode}">${firstRec}</option>`;
...
function listORG() {
    $.ajax({
		...
		success: function (data) {
			...
			console.log("drafterDept2:", drafterDept);
...
//	let formData = new FormData();
	...
	let sanctnNo = $("#sanctnNo").val();
	let sanctnSttus = $("#sanctnSttus").val();
