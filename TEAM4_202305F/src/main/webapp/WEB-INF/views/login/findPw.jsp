...
<html
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">이름, 사번, 휴대폰번호를 입력해주세요.<br>인증번호를 문자로 발송합니다.</p>
			 ...
			 <!-- ajax 로 받은 데이터 올 자리 -->
              ...
              <div class="text-center">
                <a href="/index.do" class="d-flex align-items-center justify-content-center">
 ...
 <!-- / Content -->
    <script type="text/javascript" src="/resources/js/app/login/findPassword.js"></script>
</html>