				...
				<tr>
					<td colspan="7">
						...
						<div id="searchUI"  class="row g-3 d-flex justify-content-center">
							...
							<div class="col-auto">
								<input type="text" name="drafterNm" placeholder="기안자" class="form-control"/>
							</div>
							<div class="col-auto">
...
<form id="searchForm" class="boader" action="<c:url value='/sanction/deptData' />">
	...
	<input type="hidden" name="drafterNm" readonly="readonly" placeholder="drafterNm"  />
