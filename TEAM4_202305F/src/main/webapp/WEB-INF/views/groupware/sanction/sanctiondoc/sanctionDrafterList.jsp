	...
	<div class="card-header border-bottom">
		...
		<div class="dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column mb-3 mb-md-0">
			<div class="dt-buttons">
				<button class="dt-button add-new btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser" onclick="location.href='/sanctionform'">
					<span>
...
<form id = "searchForm" class="boader" action="<c:url value='/sanction/drafterData' />">
